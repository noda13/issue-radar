          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
              ...
              {issue.summaryJa && (
                <div className="rounded-md bg-gray-50 p-4">
                  <h2 className="mb-2 text-sm font-semibold text-gray-700">要約</h2>
            ...
            {issue.affectedDomain && issue.affectedDomain.length > 0 && (
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                <h2 className="mb-3 text-sm font-semibold text-gray-700">影響領域</h2>
            ...
            {/* App Idea section */}
            {issue.ideaGeneratedAt && issue.proposedAppIdea && (
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-6 shadow-sm">
                <h2 className="mb-4 text-base font-bold text-blue-900">
                  アプリ化アイデア
                </h2>
                ...
                {issue.mvpFeatures && issue.mvpFeatures.length > 0 && (
                  <div>
                    <h3 className="mb-2 text-xs font-semibold text-blue-700">MVP機能</h3>
